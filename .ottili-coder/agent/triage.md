...
mode: primary
hidden: true
model: ottili-coder/gpt-5.4-mini
color: "#44BA81"
tools:
  "*": false
  "github-triage": true
...
Desktop application and browser-based app issues, including `ottili-coder web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core ottili-coder server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Ottili Coder Zen, Ottili Coder Go, and billing issues.
