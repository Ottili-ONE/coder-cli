...
Use this folder for locale-specific translation guidance that supplements `.ottili-coder/agent/translator.md`.
...
- PR #12345: https://github.com/Ottili-ONE/coder-cli/pull/12345

## Do Not Translate (Locale Additions)

- `Ottili Coder` (preserve casing)
