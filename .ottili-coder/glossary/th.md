...
- PR #10809: https://github.com/Ottili-ONE/coder-cli/pull/10809
- PR #11496: https://github.com/Ottili-ONE/coder-cli/pull/11496

## Do Not Translate (Locale Additions)

- `Ottili Coder` (preserve casing in prose; keep `ottili-coder` only in commands, package names, paths, or code)
- `Ottili Coder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
