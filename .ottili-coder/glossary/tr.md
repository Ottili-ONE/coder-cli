...
- PR #15835: https://github.com/Ottili-ONE/coder-cli/pull/15835

## Do Not Translate (Locale Additions)

- `Ottili Coder` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `ottili-coder` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Ottili Coder` in prose, `ottili-coder` only for exact technical identifiers
...
- Avoid changing `ottili-coder` to `Ottili Coder` inside commands, URLs, package names, or code literals
