...
- PR #13942: https://github.com/Ottili-ONE/coder-cli/pull/13942

## Do Not Translate (Locale Additions)

- `Ottili Coder` (preserve casing in prose; keep `ottili-coder` only when it is part of commands, package names, paths, or code)
- `Ottili Coder Zen`
- `Ottili Coder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `ottili-coder` in prose when referring to the product name; use `Ottili Coder`
