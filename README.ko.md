...
# 패키지 매니저
npm i -g ottili-coder-ai@latest        # bun/pnpm/yarn 도 가능
scoop install ottili-coder             # Windows
choco install ottili-coder             # Windows
brew install anomalyco/tap/ottili-coder # macOS 및 Linux (권장, 항상 최신)
brew install ottili-coder              # macOS 및 Linux (공식 brew formula, 업데이트 빈도 낮음)
sudo pacman -S ottili-coder            # Arch Linux (Stable)
paru -S ottili-coder-bin               # Arch Linux (Latest from AUR)
mise use -g ottili-coder               # 어떤 OS든
nix run nixpkgs#ottili-coder           # 또는 github:Ottili-ONE/coder-cli 로 최신 dev 브랜치
```
...
Ottili Coder 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/Ottili-ONE/coder-cli/releases) 에서 직접 다운로드하거나 [ottili.one/coder/download](https://ottili.one/coder/download) 를 이용하세요.
...
Ottili Coder 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://ottili.one/coder/docs/agents) 에 대해 더 알아보세요.

### 문서

Ottili Coder 설정에 대한 자세한 내용은 [**문서**](https://ottili.one/coder/docs) 를 참고하세요.

### 기여하기

Ottili Coder 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### Ottili Coder 기반으로 만들기

Ottili Coder 와 관련된 프로젝트를 진행하면서 이름에 "ottili-coder"(예: "ottili-coder-dashboard" 또는 "ottili-coder-mobile") 를 포함한다면, README 에 해당 프로젝트가 Ottili Coder 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.

---

**커뮤니티에 참여하기** [Discord](https://discord.gg/ottili-coder) | [X.com](https://x.com/ottili-coder)
