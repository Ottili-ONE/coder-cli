...
brew install anomalyco/tap/ottili-coder # macOS 和 Linux（推荐，始终保持最新）
brew install ottili-coder              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S ottili-coder            # Arch Linux (Stable)
paru -S ottili-coder-bin               # Arch Linux (Latest from AUR)
mise use -g ottili-coder               # 任意系统
nix run nixpkgs#ottili-coder           # 或用 github:Ottili-ONE/coder-cli 获取最新 dev 分支
```
...
Ottili Coder 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/Ottili-ONE/coder-cli/releases) 或 [ottili.one/coder/download](https://ottili.one/coder/download) 下载。
...
1. `$OTTILI_CODER_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.ottili-coder/bin` - 默认备用路径
...
Ottili Coder 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://ottili.one/coder/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://ottili.one/coder/docs)。

### 参与贡献

如有兴趣贡献代码，请在提交 PR 前阅读 [贡献指南 (Contributing Docs)](./CONTRIBUTING.md)。

### 基于 Ottili Coder 进行开发

如果你在项目名中使用了 “ottili-coder”（如 “ottili-coder-dashboard” 或 “ottili-coder-mobile”），请在 README 里注明该项目不是 Ottili Coder 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=738j8655-cd59-4633-a30a-1124e0096789&qr_code=true) | [X.com](https://x.com/ottili-coder)
