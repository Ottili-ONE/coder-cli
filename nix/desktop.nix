...
stdenv.mkDerivation (finalAttrs: {
  pname = "ottili-coder-desktop";
  inherit (ottili-coder)
    version
    src
    node_modules
    patches
  ...
  installPhase =
    ...
    + lib.optionalString stdenv.hostPlatform.isDarwin ''
      ...
      makeWrapper "$out/Applications/Ottili Coder.app/Contents/MacOS/Ottili Coder" $out/bin/ottili-coder-desktop
    ''
  ...
  meta = {
    description = "Ottili Coder Desktop App";
    mainProgram = "ottili-coder-desktop";
    inherit (ottili-coder.meta) homepage license platforms;
  };
})
