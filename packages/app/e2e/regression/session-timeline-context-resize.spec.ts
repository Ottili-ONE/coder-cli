...
import { mockOttiliCoderServer } from "../utils/mock-server"
import { expectAppVisible, expectSessionTitle } from "../utils/waits"

const directory = "C:/Ottili Coder/ContextResizeRegression"
...
const model = { providerID: "ottili-coder", modelID: "claude-opus-4-6", variant: "max" }
...
async function mockServer(page: Page) {
  await mockOttiliCoderServer(page, {
    directory,
    project: project(),
    provider: provider(),
    sessions: [session()],
...
function provider() {
  return {
    ...
    connected: ["ottili-coder"],
    default: { providerID: "ottili-coder", modelID: "claude-opus-4-6" },
  }
}
