import type { Config, OttiliCoderClient, Path, Project, ProviderAuthResponse, Todo } from "@opencode-ai/sdk/v2/client"
...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: OttiliCoderClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (scope: ServerScope, directory: string, sdk: OttiliCoderClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => OttiliCoderClient,
) {
  return {
...
export function createServerSyncContextInner(_serverSDK?: ServerSDK) {
  ...
  const sdkCache = new Map<string, OttiliCoderClient>()
