...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Ottili Coder Documentation", href: "https://ottili.one/coder/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/ottili-coder" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/Ottili-ONE/coder-cli/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/Ottili-ONE/coder-cli/issues/new?template=bug_report.yml",
      },
    ],
  },
]
