export const dict = {
  ...
  "dialog.provider.ottiliCoder.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.ottiliCoder.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.ottiliCoderGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Ottili Coder",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Ottili Coder.",
  ...
  "provider.connect.ottiliCoderZen.line1":
    "Ottili Coder Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.ottiliCoderZen.visit.prefix": "Visite ",
  "provider.connect.ottiliCoderZen.visit.link": "ottili.one/coder/zen",
  "provider.connect.ottiliCoderZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Ottili Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Ottili Coder.",
  ...
  "dialog.plugins.empty": "Plugins configurados em ottiliCoder.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Ottili Coder este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Ottili Coder ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Ottili Coder",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (ottiliCoder.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: OttiliCoder ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Ottili Coder inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Ottili Coder dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Ottili Coder",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Ottili Coder aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Ottili Coder segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Ottili Coder é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Ottili Coder iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Ottili Coder.",
