export const dict = {
  ...
  "dialog.provider.ottiliCoder.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.ottiliCoder.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.ottiliCoderGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Ottili Coder",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Ottili Coder u.",
  ...
  "provider.connect.ottiliCoderZen.line1":
    "Ottili Coder Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.ottiliCoderZen.visit.prefix": "Posjeti ",
  "provider.connect.ottiliCoderZen.visit.link": "ottili.one/coder/zen",
  "provider.connect.ottiliCoderZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Ottili Coder u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Ottili Coder u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u ottiliCoder.json",
  ...
  "dialog.server.description": "Promijeni na koji se Ottili Coder server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Ottili Coder a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Ottili Coder timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (ottiliCoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OttiliCoder još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Ottili Coder uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Ottili Coder server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Ottili Coder u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Ottili Coder izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Ottili Coder prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Ottili Coder a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Ottili Coder pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Ottili Coder a.",
