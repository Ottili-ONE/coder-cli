export const dict = {
  ...
  "dialog.provider.ottiliCoder.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.ottiliCoder.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.ottiliCoderGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Ottili Coder",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Ottili Coder.",
  ...
  "provider.connect.ottiliCoderZen.line1":
    "Ottili Coder Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.ottiliCoderZen.visit.prefix": "Besøg ",
  "provider.connect.ottiliCoderZen.visit.link": "ottili.one/coder/zen",
  "provider.connect.ottiliCoderZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Ottili Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Ottili Coder.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i ottiliCoder.json",
  ...
  "dialog.server.description": "Skift hvilken Ottili Coder server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Ottili Coder ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Ottili Coder teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (ottiliCoder.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Ottili Coder understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Ottili Coder inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Ottili Coder serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Ottili Coder",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Ottili Coder ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Ottili Coder følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Ottili Coder er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Ottili Coder starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Ottili Coder.",
