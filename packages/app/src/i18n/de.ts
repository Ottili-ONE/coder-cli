...
export const dict = {
  ...
  "dialog.provider.ottiliCoder.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.ottiliCoder.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.ottiliCoderGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Ottili Coder",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Ottili Coder zu nutzen.",
  ...
  "provider.connect.ottiliCoderZen.line1":
    "Ottili Coder Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.ottiliCoderZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.ottiliCoderZen.visit.link": "ottili.one/coder/zen",
  "provider.connect.ottiliCoderZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Ottili Coder zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Ottili Coder zu nutzen.",
  ...
  "dialog.plugins.empty": "In ottiliCoder.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Ottili Coder Server, mit dem sich diese App verbindet.",
  ...
  "context.usage.state.loading": "Kontextnutzung: wird geladen",
  "context.usage.state.loadingHint": "Sitzungsaktivität wird gesammelt…",
  "context.usage.state.empty": "Kontextnutzung: noch keine Aktivität",
  "context.usage.state.emptyHint": "Die Token-Nutzung erscheint, sobald der Assistent antwortet.",
  "context.usage.state.populated": "Kontextnutzung",
  "context.usage.state.longContent": "Kontextnutzung: großer Kontext",
  "context.usage.state.longContentHint": "Token-Zahlen sind für diese Ansicht komprimiert.",
  "context.usage.state.degraded": "Kontextnutzung: Grenze unbekannt",
  "context.usage.state.degradedHint": "Anbietermetadaten fehlen, daher kann die Prozentzahl nicht berechnet werden.",
  "context.usage.state.failure": "Kontextnutzung: Ladefehler",
  "context.usage.state.failureHint": "Die Sitzungsmetriken konnten nicht gelesen werden.",
  "context.usage.state.denied": "Kontextnutzung: Zugriff verweigert",
  "context.usage.state.deniedHint": "Keine Berechtigung zum Lesen dieser Metriken.",
  "context.usage.state.offline": "Kontextnutzung: offline",
  "context.usage.state.offlineHint": "Verbindung wiederherstellen, um die aktuelle Nutzung zu aktualisieren.",
  "language.en": "English",
  "language.zh": "简体中文",
  "language.zht": "繁體中文",
  "language.ko": "한국어",
  ...
  "toast.update.description": "Eine neue Version von Ottili Coder ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Ottili Coder Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (ottiliCoder.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OttiliCoder unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Ottili Coder enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Ottili Coder Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Ottili Coder ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Ottili Coder auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Ottili Coder dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Ottili Coder anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Ottili Coder automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Ottili Coder.",
