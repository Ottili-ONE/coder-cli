export const dict = {
  ...
  "dialog.provider.ottiliCoder.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.ottiliCoder.tagline": "Reliable optimized models",
  "dialog.provider.ottiliCoderGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Ottili Coder",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Ottili Coder.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.ottiliCoderZen.line1":
    "Ottili Coder Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.ottiliCoderZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.ottiliCoderZen.visit.prefix": "Visit ",
  "provider.connect.ottiliCoderZen.visit.link": "ottili.one/coder/zen",
  "provider.connect.ottiliCoderZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Ottili Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Ottili Coder.",
  ...
  "dialog.plugins.empty": "Plugins configured in ottiliCoder.json",
  ...
  "dialog.server.description": "Switch which Ottili Coder server this app connects to.",
  ...
  "wsl.onboarding.step.ottili-coder": "Ottili Coder",
  ...
  "wsl.onboarding.checkingOttiliCoder": "Checking Ottili Coder...",
  "wsl.onboarding.checkingOttiliCoderIn": "Checking Ottili Coder in {{distro}}...",
  "wsl.onboarding.updatingOttiliCoder": "Updating Ottili Coder...",
  "wsl.onboarding.updatingOttiliCoderIn": "Updating Ottili Coder in {{distro}}...",
  "wsl.onboarding.updateOttiliCoderIn": "Update Ottili Coder in {{distro}}.",
  "wsl.onboarding.updateOttiliCoder": "Update Ottili Coder",
  "wsl.onboarding.ottiliCoderReadyIn": "Ottili Coder is ready in {{distro}}.",
  "wsl.onboarding.ottiliCoderReady": "Ottili Coder is ready.",
  "wsl.onboarding.installOttiliCoderIn": "Install Ottili Coder in {{distro}}.",
  "wsl.onboarding.installOttiliCoder": "Install Ottili Coder",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Ottili Coder.",
  ...
  "context.usage.state.loading": "Context usage: loading",
  "context.usage.state.loadingHint": "Gathering session activity…",
  "context.usage.state.empty": "Context usage: no activity yet",
  "context.usage.state.emptyHint": "Token usage appears once the assistant replies.",
  "context.usage.state.populated": "Context usage",
  "context.usage.state.longContent": "Context usage: large context",
  "context.usage.state.longContentHint": "Token counts are compacted for this view.",
  "context.usage.state.degraded": "Context usage: limit unknown",
  "context.usage.state.degradedHint": "Provider metadata is unavailable, so the percentage cannot be computed.",
  "context.usage.state.failure": "Context usage: failed to load",
  "context.usage.state.failureHint": "The session metrics could not be read.",
  "context.usage.state.denied": "Context usage: access denied",
  "context.usage.state.deniedHint": "You do not have permission to read these metrics.",
  "context.usage.state.offline": "Context usage: offline",
  "context.usage.state.offlineHint": "Reconnect to refresh the latest usage.",
  ...
  "toast.update.description": "A new version of Ottili Coder ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Ottili Coder team",
  ...
  "error.chain.checkConfig": "Check your config (ottiliCoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Ottili Coder does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Ottili Coder includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Ottili Coder Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Ottili Coder server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Ottili Coder",
  ...
  "settings.general.row.appearance.description": "Customise how Ottili Coder looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Ottili Coder follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Ottili Coder is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Ottili Coder launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Ottili Coder.",
