export const dict = {
  ...
  "dialog.provider.ottiliCoder.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.ottiliCoder.tagline": "Modelos optimizados y fiables",
  "dialog.provider.ottiliCoderGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Ottili Coder",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Ottili Coder.",
  ...
  "provider.connect.ottiliCoderZen.line1":
    "Ottili Coder Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.ottiliCoderZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.ottiliCoderZen.visit.prefix": "Visita ",
  "provider.connect.ottiliCoderZen.visit.link": "ottili.one/coder/zen",
  "provider.connect.ottiliCoderZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Ottili Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Ottili Coder.",
  ...
  "dialog.plugins.empty": "Plugins configurados en ottiliCoder.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Ottili Coder se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Ottili Coder ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Ottili Coder",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (ottiliCoder.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Ottili Coder no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Ottili Coder incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Ottili Coder dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Ottili Coder",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Ottili Coder en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Ottili Coder sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Ottili Coder.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Ottili Coder",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Ottili Coder.",
