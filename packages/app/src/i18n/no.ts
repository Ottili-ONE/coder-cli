...
export const dict = {
  ...
  "dialog.provider.ottiliCoder.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.ottiliCoder.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.ottiliCoderGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Ottili Coder",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Ottili Coder.",
  ...
  "provider.connect.ottiliCoderZen.line1":
    "Ottili Coder Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.ottiliCoderZen.visit.prefix": "Besøk ",
  "provider.connect.ottiliCoderZen.visit.link": "ottili.one/coder/zen",
  "provider.connect.ottiliCoderZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Ottili Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Ottili Coder.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i ottiliCoder.json",
  ...
  "dialog.server.description": "Bytt hvilken Ottili Coder server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Ottili Coder ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Ottili Coder teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (ottiliCoder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Ottili Coder ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Ottili Coder inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Ottili Coder serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Ottili Coder",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Ottili Coder ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Ottili Coder skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Ottili Coder er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Ottili Coder starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Ottili Coder.",
