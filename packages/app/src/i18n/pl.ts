export const dict = {
  ...
  "dialog.provider.ottiliCoder.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.ottiliCoder.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.ottiliCoderGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Ottili Coder",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Ottili Coder.",
  ...
  "provider.connect.ottiliCoderZen.line1":
    "Ottili Coder Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.ottiliCoderZen.visit.prefix": "Odwiedź ",
  "provider.connect.ottiliCoderZen.visit.link": "ottili.one/coder/zen",
  "provider.connect.ottiliCoderZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Ottili Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Ottili Coder.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w ottiliCoder.json",
  ...
  "dialog.server.description": "Przełącz serwer Ottili Coder, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Ottili Coder ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Ottili Coder",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (ottiliCoder.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Ottili Coder zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Ottili Coder",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Ottili Coder na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Ottili Coder ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Ottili Coder.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Ottili Coder",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Ottili Coder.",
