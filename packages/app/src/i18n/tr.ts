...
export const dict = {
  ...
  "dialog.provider.ottiliCoder.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.ottiliCoder.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.ottiliCoderGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Ottili Coder tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Ottili Coder'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.ottiliCoderZen.line1":
    "Ottili Coder Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.ottiliCoderZen.visit.prefix": "",
  "provider.connect.ottiliCoderZen.visit.link": "ottili.one/coder/zen",
  "provider.connect.ottiliCoderZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Ottili Coder'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Ottili Coder'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler ottiliCoder.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Ottili Coder sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Ottili Coder'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Ottili Coder ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (ottiliCoder.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OttiliCoder henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Ottili Coder ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Ottili Coder Masaüstü",
  ...
  "settings.desktop.wsl.description": "Ottili Coder sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Ottili Coder'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Ottili Coder'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Ottili Coder'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Ottili Coder'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Ottili Coder başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Ottili Coder'un en son sürümünü kullanıyorsunuz.",
