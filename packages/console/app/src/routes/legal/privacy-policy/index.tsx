...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>Ottili Coder | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="Ottili Coder privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Ottili Coder, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Ottili Coder is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://ottili.one/coder/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Ottili Coder website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about Ottili Coder.
                </li>
              ...
              <p>
                ...
                you, Ottili Coder or another party; enforcing any agreements with you; responding to claims that any posting
