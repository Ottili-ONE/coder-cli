...
import compareVideo from "../../asset/lander/ottili-coder-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/ottili-coder-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="ottiliCoder:auth" content={loggedin() ? "true" : "false"} />
