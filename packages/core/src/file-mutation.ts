...
export class Service extends Context.Service<Service, Interface>()("@opencode-ai/v2/FileMutation") {}

/**
 * Serialize file changes by canonical target. Conditional writes compare and
 * write under the same process-local lock so cooperating Ottili Coder mutations do
