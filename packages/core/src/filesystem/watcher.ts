...
declare const OTTILI_CODER_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OTTILI_CODER_LIBC === "undefined" ? undefined : OTTILI_CODER_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@opencode-ai/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OTTILI_CODER_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.OTTILI_CODER_EXPERIMENTAL_FILEWATCHER) {
