export * as OttiliCoder from "./ottili-coder"
...
/** Intentional public native API for Effect applications embedding Ottili Coder. */
export class Service extends Context.Service<Service, Interface>()("@opencode-ai/public/OttiliCoder") {}
...
>()("@opencode-ai/public/OttiliCoder/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("OttiliCoder.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("OttiliCoder.sessions.switchModel")(function* (input) {
...
// TODO: Add OttiliCoder.create(...) as the Promise facade over the same native API semantics.
