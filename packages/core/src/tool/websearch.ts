...
export class ConfigService extends Context.Service<ConfigService, Config>()("@opencode-ai/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.OTTILI_CODER_WEBSEARCH_PROVIDER === "exa" || process.env.OTTILI_CODER_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.OTTILI_CODER_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("OTTILI_CODER_EXPERIMENTAL") || truthy("OTTILI_CODER_ENABLE_EXA") || truthy("OTTILI_CODER_EXPERIMENTAL_EXA"),
    enableParallel: truthy("OTTILI_CODER_ENABLE_PARALLEL") || truthy("OTTILI_CODER_EXPERIMENTAL_PARALLEL"),
              ...
              const text =
                provider === "exa"
                  ...
                  : yield* callMcp(
                      ...
                      {
                        "User-Agent": `ottili-coder/${InstallationVersion}`,
