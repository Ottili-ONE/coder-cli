...
const releaseId = process.env.OTTILI_CODER_RELEASE
if (!releaseId) throw new Error("OTTILI_CODER_RELEASE is required")

const version = process.env.OTTILI_CODER_VERSION
if (!version) throw new Error("OTTILI_CODER_VERSION is required")
...
const macxTarGz = "ottili-coder-desktop-mac-x64.app.tar.gz"
const macaTarGz = "ottili-coder-desktop-mac-arm64.app.tar.gz"
