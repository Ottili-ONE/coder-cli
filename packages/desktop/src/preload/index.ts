...
const api: ElectronAPI = {
  ...
  wslServers: {
    ...
    probeOttiliCoder: (name) => ipcRenderer.invoke("wsl-servers-probe-ottili-coder", name),
    installOttiliCoder: (name) => ipcRenderer.invoke("wsl-servers-install-ottili-coder", name),
