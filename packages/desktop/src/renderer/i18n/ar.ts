export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Ottili Coder",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Ottili Coder، هل ترغب في تثبيته وإعادة تشغيله؟",
