export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Ottili Coder",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Ottili Coder er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'ottili-coder'-kommandoen.",
