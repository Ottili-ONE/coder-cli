export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Ottili Coder",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Ottili Coder wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'ottili-coder' zu verwenden.",
