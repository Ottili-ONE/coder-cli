export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Ottili Coder を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Ottili Coder のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'ottili-coder' コマンドを使用してください。",
