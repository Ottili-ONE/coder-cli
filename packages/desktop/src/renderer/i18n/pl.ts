export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Ottili Coder",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Ottili Coder. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'ottili-coder'.",
