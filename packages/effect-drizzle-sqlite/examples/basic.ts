...
class Database extends Context.Service<Database, DatabaseShape>()("@opencode-ai/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@opencode-ai/example/UserStore") {
