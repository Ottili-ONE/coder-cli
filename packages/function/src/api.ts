...
export default new Hono<{ Bindings: Env }>()
  ...
  .post("/exchange_github_app_token", async (c) => {
    const EXPECTED_AUDIENCE = "ottili-coder-github-action"
  ...
  /**
   * Used by the GitHub action to get GitHub installation access token given user PAT token (used when testing `ottili-coder github run` locally)
   */
  ...
  /**
   * Used by the ottili-coder CLI to check if the GitHub app is installed
   */
