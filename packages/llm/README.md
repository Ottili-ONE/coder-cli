...
Schema-first LLM core for ottili-coder. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@ottili-coder/llm"
import { OpenAI } from "@ottili-coder/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@ottili-coder/llm/providers"
