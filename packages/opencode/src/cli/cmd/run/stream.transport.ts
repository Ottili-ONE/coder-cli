...
import type { Event, GlobalEvent, OttiliCoderClient } from "@opencode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@opencode-ai/RunStreamTransport") {}
