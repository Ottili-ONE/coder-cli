...
//
// The saved variant persists across sessions in ~/.local/state/ottili-coder/model.json
...
class Service extends Context.Service<Service, VariantService>()("@opencode-ai/RunVariant") {}
