...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips ottili-coder-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-ottili-coder-directory"]).toBeUndefined()
      expect(forwarded["x-ottili-coder-workspace"]).toBeUndefined()
