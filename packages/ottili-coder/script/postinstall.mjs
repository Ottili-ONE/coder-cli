...
function installPackage(name) {
  ...
  const temp = fs.mkdtempSync(path.join(os.tmpdir(), "ottili-coder-install-"))
  try {
...
function main() {
  ...
  throw new Error(
    `It seems your package manager failed to install the right ottili-coder CLI package. Try manually installing ${packageNames()
