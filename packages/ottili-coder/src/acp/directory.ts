...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@opencode-ai/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@opencode-ai/ACPDirectory") {}
