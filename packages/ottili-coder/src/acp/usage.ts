...
import type { AssistantMessage as OttiliCoderAssistantMessage, Message } from "@opencode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<OttiliCoderAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OttiliCoderAssistantMessage, "role"> &
  Partial<Pick<OttiliCoderAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@opencode-ai/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@opencode-ai/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@opencode-ai/ACPUsage") {}
