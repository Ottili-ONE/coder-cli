...
async function target() {
  if (typeof OTTILI_CODER_WORKER_PATH !== "undefined") return OTTILI_CODER_WORKER_PATH
...
export const TuiThreadCommand = cmd({
  command: "$0 [project]",
  describe: "start ottili-coder tui",
  builder: (yargs) =>
    withNetworkOptions(yargs)
      .positional("project", {
        type: "string",
        describe: "path to start ottili-coder in",
      })
      .option("model", {
        type: "string",
        alias: ["m"],
