...
export class Service extends Context.Service<Service, Interface>()("@opencode-ai/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __OTTILI_CODER_PHOTON_WASM_PATH?: string }).__OTTILI_CODER_PHOTON_WASM_PATH =
