...
export const RootHttpApi = HttpApi.make("ottili-coder-root")
...
export const InstanceHttpApi = HttpApi.make("ottili-coder-instance")
...
export const OttiliCoderHttpApi = HttpApi.make("ottili-coder")
