...
const OTTILI_CODER_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
const SKILL_PATTERN = "**/SKILL.md"

// Built-in skill that ships with ottiliCoder. The model's intuition for what an
// ottiliCoder.json should look like is often wrong, and ottili-coder hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch ottili-coder's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_OTTILI_CODER_SKILL_NAME = "customize-ottili-coder"
const CUSTOMIZE_OTTILI_CODER_SKILL_DESCRIPTION =
...
const CUSTOMIZE_OTTILI_CODER_SKILL_BODY = SkillPlugin.CustomizeOttiliCoderContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, OTTILI_CODER_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@opencode-ai/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_OTTILI_CODER_SKILL_NAME] = {
          name: CUSTOMIZE_OTTILI_CODER_SKILL_NAME,
          description: CUSTOMIZE_OTTILI_CODER_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_OTTILI_CODER_SKILL_BODY,
        }
