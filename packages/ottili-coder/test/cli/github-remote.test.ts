...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/ottiliCoder.git")).toEqual({ owner: "sst", repo: "ottili-coder" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/ottili-coder")).toEqual({ owner: "sst", repo: "ottili-coder" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/ottiliCoder.git")).toEqual({ owner: "sst", repo: "ottili-coder" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/ottili-coder")).toEqual({ owner: "sst", repo: "ottili-coder" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/ottiliCoder.git")).toEqual({ owner: "sst", repo: "ottili-coder" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/ottili-coder")).toEqual({ owner: "sst", repo: "ottili-coder" })
})
