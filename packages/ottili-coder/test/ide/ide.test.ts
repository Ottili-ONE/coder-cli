...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OTTILI_CODER_CALLER", () => {
    process.env["OTTILI_CODER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OTTILI_CODER_CALLER", () => {
    process.env["OTTILI_CODER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OTTILI_CODER_CALLER", () => {
    process.env["OTTILI_CODER_CALLER"] = "unknown"
