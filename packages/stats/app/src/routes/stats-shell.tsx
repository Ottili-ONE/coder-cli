import ottiliCoderWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  href: "https://github.com/Ottili-ONE/coder-cli",
  apiHref: "https://api.github.com/repos/Ottili-ONE/coder-cli",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star Ottili Coder on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "ottiliCoder:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://ottili.one/coder/">
            <strong>Try Ottili Coder</strong>
          </a>
          <button
...
function OttiliCoderMark() {
  return (
    <svg data-slot="ottili-coder-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://ottili.one/coder/legal/terms-of-service", label: "Terms of service" },
    { href: "https://ottili.one/coder/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@ottili.one/coder", label: "Contact us" },
    { href: "https://ottili.one/coder/discord", label: "Community" },
    { href: "https://x.com/ottili-coder", label: "X" },
    githubLink,
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={ottiliCoderWordmarkDark} alt="Ottili Coder" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">Ottili Coder Newsletter</h2>
            <p>
