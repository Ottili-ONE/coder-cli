...
export const Definitions = {
  ...
  diff_accept_hunk: keybind("a", "Accept the current diff hunk"),
  diff_reject_hunk: keybind("r", "Reject the current diff hunk"),
  diff_accept_file: keybind("A", "Accept all hunks in the current file"),
  diff_reject_file: keybind("R", "Reject all hunks in the current file"),
  ...
  session_search: keybind("<leader>/", "Search across session"),
  ...
  session_toolcard_toggle: keybind("o", "Toggle the focused tool-call card"),
  ...
  provider_connect: keybind("<leader>p", "Connect AI provider"),
...
export const CommandMap = {
  ...
  diff_accept_hunk: "diff.accept_hunk",
  diff_reject_hunk: "diff.reject_hunk",
  diff_accept_file: "diff.accept_file",
  diff_reject_file: "diff.reject_file",
  ...
  session_toolcard_toggle: "session.toolcard.toggle",
