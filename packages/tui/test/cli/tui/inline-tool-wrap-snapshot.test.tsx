...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/ottili-coder/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/ottili-coder (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/ottili-coder/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/ottili-coder/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OTTILI_CODER_DB|OTTILI_CODER_DB|OTTILI_CODER_DEV|Global\\.Path\\.data|data =" in packages/ottili-coder/src (115 matches)',
  },
] as const
