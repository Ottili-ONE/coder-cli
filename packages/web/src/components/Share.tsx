...
import { IconOttiliCoder } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "ottili-coder/session/message-v2"
import type { Message } from "ottili-coder/session/message"
import type { Session } from "ottili-coder/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.ottili-coder_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.ottili-coder_name}>
                    <IconOttiliCoder width={16} height={16} />
                  </div>
