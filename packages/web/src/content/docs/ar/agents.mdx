...
يوجد نوعان من الوكلاء في Ottili Coder: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Ottili Coder مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Ottili Coder مع ثلاثة وكلاء فرعيين مدمجين: **General** و **Explore** و **Scout**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Ottili Coder مع وكيلين أساسيين مدمجين وثلاثة وكلاء فرعيين مدمجين.
...
وكيل للقراءة فقط مخصص للوثائق الخارجية وأبحاث التبعيات. استخدمه عندما تحتاج إلى استنساخ مستودع تبعية داخل ذاكرة التخزين المؤقت المُدارة في Ottili Coder، أو فحص الشفرة المصدرية لمكتبة، أو إجراء مراجع متقاطعة بين الشفرة المحلية والتنفيذات upstream بدون تعديل مساحة العمل الخاصة بك.
...
هيّئ الوكلاء في ملف إعدادات `ottili-coder.json`:
...
- عام: `~/.config/ottili-coder/agents/`
- لكل مشروع: `.ottili-coder/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Ottili Coder القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Ottili Coder العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Ottili Coder الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Ottili Coder](/docs/zen)، فستستخدم `ottili-coder/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `ottili-coder models` لعرض قائمة بالنماذج المتاحة.
:::
