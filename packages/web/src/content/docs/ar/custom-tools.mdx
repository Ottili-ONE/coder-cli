...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في ottili-coder.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في ottili-coder مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.ottili-coder/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/ottili-coder/tools/`.
