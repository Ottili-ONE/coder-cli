...
Kreiraj `.ottili-coder/commands/test.md`:
...
Možete dodati prilagođene komande kroz Ottili Coder konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Ottili Coder [config](/docs/config):
...
- Globalno: `~/.config/ottili-coder/commands/`
- Po projektu: `.ottili-coder/commands/`
...
Ottili Coder uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
