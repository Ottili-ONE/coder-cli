...
Ottili Coder Go je povoljna pretplata — **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno** — koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

Go radi kao bilo koji drugi provajder u Ottili Coder-u. Pretplatite se na Ottili Coder Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili Ottili Coder.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa Ottili Coder-om.
:::
...
Ottili Coder Go vam daje pristup ovim modelima za **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno**.

---

## Kako funkcioniše

Ottili Coder Go radi kao bilo koji drugi provajder u Ottili Coder-u.

1. Prijavite se na **<a href={console}>Ottili Coder</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI-ju, odaberite `Ottili Coder Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih kroz Go.

:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na Ottili Coder Go.
:::
...
Ottili Coder Go uključuje sljedeća ograničenja:
...
[Model id](/docs/config/#models) u vašoj Ottili Coder konfiguraciji
...
Napravili smo Ottili Coder Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz Ottili Coder koristite i bilo kojeg drugog provajdera.
