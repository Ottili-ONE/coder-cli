---
title: SDK
description: Type-safe JS klijent za ottili-coder server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

ottili-coder JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
...
Kreirajte instancu ottili-coder:
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `ottili-coder.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu ottili-coder instancu, mozete napraviti klijentsku instancu i povezati se na nju:
