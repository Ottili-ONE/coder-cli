---
title: Dijeljenje
description: Dijelite Ottili Coder razgovore javnim linkovima.
---

Ottili Coder opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, Ottili Coder:
...
Ottili Coder podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, Ottili Coder koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `ottili-coder.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju ottili-coder u organizaciji.
