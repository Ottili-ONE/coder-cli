...
Create `.ottili-coder/commands/test.md`:
...
You can add custom commands through the Ottili Coder config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Ottili Coder [config](/docs/config):
...
- Per-project: `.ottili-coder/commands/`
...
ottili-coder includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
