...
Der er to typer agenter i Ottili Coder; primære agenter og subagenter.
...
Ottili Coder leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Ottili Coder leveres med tre indbyggede subagenter, **General**, **Explore** og **Scout**. Vi ser nærmere på dem nedenfor.

---

## Indbyggede

Ottili Coder leveres med to indbyggede primære agenter og tre indbyggede subagenter.
...
En skrivebeskyttet agent til eksterne docs og research af dependencies. Brug denne, når du har brug for at klone et dependency-repository ind i Ottili Coder's administrerede cache, inspicere kildekoden i et bibliotek eller krydstjekke lokal kode mod upstream-implementeringer uden at ændre dit workspace.
...
Konfigurer agent i din `ottili-coder.json`-konfigurationsfil:
...
- Globalt: `~/.config/ottili-coder/agents/`
- Pr. projekt: `.ottili-coder/agents/`
...
Hvis ingen temperatur er angivet, bruger Ottili Coder modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Ottili Coder-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Ottili Coder-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Ottili Coder](/docs/zen), vil du bruge `ottili-coder/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `ottili-coder models` for at se en liste over de tilgængelige modeller.
:::
