...
description: Opret værktøjer, som LLM kan kalde ottili-coder ind.
---
...
- Lokalt ved at placere dem i biblioteket `.ottili-coder/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/ottili-coder/tools/`.
