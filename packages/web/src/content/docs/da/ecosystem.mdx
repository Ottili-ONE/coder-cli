---
title: Økosystem
description: Projekter og integrationer bygget med Ottili Coder.
---

En samling af samfundsprojekter bygget på Ottili Coder.

:::note
Vil du tilføje dit Ottili Coder-relaterede projekt til denne liste? Send en PR.
:::

Du kan også tjekke [awesome-ottili-coder](https://github.com/awesome-ottili-coder/awesome-ottili-coder) og [ottili-coder.cafe](https://ottili.one/coder), et fællesskab, der samler økosystemet og fællesskabet.
...
| Navn                                                                                               | Beskrivelse                                                                                                       |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Kør automatisk Ottili Coder-sessioner i isolerede Daytona-sandkasser med git-synkronisering og live forhåndsvisninger |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor Ottili Coder brug med Wakatime                                                                                   |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Skrivebordsmeddelelser og lydadvarsler for Ottili Coder-sessioner                                                     |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-drevet automatisk Zellij-sessionsnavngivning baseret på Ottili Coder-kontekst                                      |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Tillad Ottili Coder-agenter til dovne load-prompter på efterspørgsel med færdighedsopdagelse og -injektion            |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Udvid ottili-coder /commands til et kraftfuldt orkestreringssystem med granulær flowkontrol                           |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS-meddelelser for Ottili Coder – ved, hvornår opgaver er fuldført                                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nulfriktions git-arbejdstræer for Ottili Coder                                                                        |
...
| Navn                                                                                       | Beskrivelse                                                            |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot til at styre Ottili Coder-sessioner, bygget på SDK             |
| [ottili-coder.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim-plugin til redaktør-bevidste prompter, bygget på API            |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI til Ottili Coder over Tailscale/VPN                    |
| [ottili-coder plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Skabelon til at bygge Ottili Coder plugins                                 |
| [ottili-coder.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-frontend til ottili-coder - en terminalbaseret AI-kodningsagent     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK udbyder til brug af Ottili Coder via @opencode-ai/sdk        |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App og VS Code udvidelse til Ottili Coder                    |
| [Ottili Coder-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin, der integrerer Ottili Coder i Obsidians brugergrænseflade |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et open source-alternativ til Claude Cowork, drevet af Ottili Coder        |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Ottili Coder udvidelsesmanager med bærbare, isolerede profiler.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop-, web-, mobil- og fjernklientapp til Ottili Coder                  |
