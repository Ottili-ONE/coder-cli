---
title: LSP-servere
description: Ottili Coder integreres med dine LSP-servere.
---

Ottili Coder kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Ottili Coder leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OTTILI_CODER_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og ottili-coder åbner en fil, vil den:
