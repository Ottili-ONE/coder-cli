...
Brug den til at bygge integrasjoner og kontrollere ottili-coder programmatisk.
...
Opret en forekomst av ottili-coder:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `ottili-coder.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av ottili-coder, kan du oprete en klientforekomst for at koble til den:
