---
title: Deling
description: Del dine Ottili Coder-samtaler.
---

Ottili Coders delingsfunksjon lar deg lage offentlige lenker til dine Ottili Coder-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Ottili Coder:
...
Ottili Coder støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Ottili Coder manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `ottili-coder.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av ottili-coder i organisasjonen din.
