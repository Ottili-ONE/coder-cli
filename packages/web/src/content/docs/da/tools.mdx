...
Her er alle de innebygde verktøyene som er tilgængelige i Ottili Coder.
...
:::note
Dette verktøyet er bare tilgængelig når `OTTILI_CODER_EXPERIMENTAL_LSP_TOOL=true` (eller `OTTILI_CODER_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Ottili Coder-leverandøren eller når miljøvariabelen `OTTILI_CODER_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
