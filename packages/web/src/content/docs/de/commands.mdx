...
Erstellen Sie `.ottili-coder/commands/test.md`:

```md title=".ottili-coder/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Ottili Coder-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Ottili Coder [config](/docs/config):

```json title="ottili-coder.jsonc" {4-12}
{
...
- Global: `~/.config/ottili-coder/commands/`
- Pro Projekt: `.ottili-coder/commands/`

```markdown title="~/.config/ottili-coder/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".ottili-coder/commands/component.md"
---
...
```md title=".ottili-coder/commands/create-file.md"
---
...
```md title=".ottili-coder/commands/analyze-coverage.md"
---
...
```md title=".ottili-coder/commands/review-changes.md"
---
...
```md title=".ottili-coder/commands/review-component.md"
---
...
Ottili Coder enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
