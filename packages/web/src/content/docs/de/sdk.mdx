...
Das ottili-coder JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und ottili-coder programmatisch steuern.
...
`ottili-coder.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn ottili-coder bereits laeuft, kannst du nur einen Client erstellen und verbinden:
