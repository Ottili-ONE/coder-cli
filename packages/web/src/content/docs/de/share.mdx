---
title: Teilen
description: Teile Ottili Coder-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Ottili Coder-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Ottili Coder Folgendes:
...
Ottili Coder hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Ottili Coder den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`ottili-coder.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du ottili-coder in deiner Organisation einsetzt.
