---
title: Ecosystem
description: Projects and integrations built with Ottili Coder.
---

A collection of community projects built on Ottili Coder.

:::note
Want to add your Ottili Coder related project to this list? Submit a PR.
:::

You can also check out [awesome-ottili-coder](https://github.com/awesome-ottili-coder/awesome-ottili-coder) and [ottili-coder.cafe](https://ottili.one/coder), a community that aggregates the ecosystem and community.
...
| Name                                                                                               | Description                                                                                        |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run Ottili Coder sessions in isolated Daytona sandboxes with git sync and live previews  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Ottili Coder usage with Wakatime                                                                 |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Ottili Coder sessions                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Ottili Coder context                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Ottili Coder agents to lazy load prompts on demand with skill discovery and injection            |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend ottili-coder /commands into a powerful orchestration system with granular flow control          |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Ottili Coder – know when tasks complete                                    |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Ottili Coder                                                           |
...
| [opencode-goal-plugin](https://github.com/willytop8/Ottili Coder-goal-plugin)                          | Session-scoped `/goal` workflow that keeps objectives in context and auto-continues until complete |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control Ottili Coder sessions, built on the SDK       |
| [ottili-coder.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim plugin for editor-aware prompts, built on the API         |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Ottili Coder over Tailscale/VPN              |
| [ottili-coder plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Ottili Coder plugins                           |
| [ottili-coder.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for ottili-coder - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Ottili Coder via @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Ottili Coder             |
| [Ottili Coder-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds Ottili Coder in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by Ottili Coder |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Ottili Coder extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for Ottili Coder          |
