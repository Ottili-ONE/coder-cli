...
Crear `.ottili-coder/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Ottili Coder o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Ottili Coder [config](/docs/config):
...
- Por proyecto: `.ottili-coder/commands/`
...
ottili-coder incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
