---
title: Servidor
description: Interactuar con el servidor ottili-coder a través de HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El comando `ottili-coder serve` ejecuta un servidor HTTP sin cabeza que expone un punto final OpenAPI que un cliente ottili-coder puede usar.
...
| `--mdns-domain` | Nombre de dominio personalizado para el servicio mDNS | `ottili-coder.local` |
...
Configure `OTTILI_CODER_SERVER_PASSWORD` para proteger el servidor con autenticación básica HTTP. El nombre de usuario predeterminado es `ottili-coder`, o configure `OTTILI_CODER_SERVER_USERNAME` para anularlo. Esto se aplica tanto a `ottili-coder serve` como a `ottili-coder web`.
...
Cuando ejecuta `ottili-coder`, inicia un TUI y un servidor. Donde el TUI es el
...
:::tip
Utilice el servidor ottili-coder para interactuar con ottili-coder mediante programación.
:::

Esta arquitectura permite que ottili-coder admita múltiples clientes y le permite interactuar con ottili-coder mediante programación.

Puede ejecutar `ottili-coder serve` para iniciar un servidor independiente. Si tienes el
ottili-coder TUI ejecutándose, `ottili-coder serve` iniciará un nuevo servidor.
...
El punto final [`/tui`](#tui) se puede utilizar para conducir el TUI a través del servidor. Por ejemplo, puede completar previamente o ejecutar un mensaje. Esta configuración es utilizada por los complementos Ottili Coder [IDE](/docs/ide).
...
El servidor ottili-coder expone las siguientes API.
