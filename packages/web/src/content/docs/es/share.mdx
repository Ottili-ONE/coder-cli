---
title: Compartir
description: Comparte tus conversaciones Ottili Coder.
---

La función para compartir de Ottili Coder te permite crear enlaces públicos a tus conversaciones de Ottili Coder, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Ottili Coder:
...
Ottili Coder admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Ottili Coder usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `ottili-coder.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de ottili-coder en su organización.
