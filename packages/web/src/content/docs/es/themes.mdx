...
Con Ottili Coder puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Ottili Coder usa nuestro propio tema `ottili-coder`.
...
Ottili Coder viene con varios temas integrados.
...
- Quiere que Ottili Coder coincida con la apariencia de su terminal
...
Ottili Coder admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/ottili-coder/themes/*.json` o `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.ottili-coder/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.ottili-coder/themes/*.json`
