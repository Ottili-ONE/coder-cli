---
title: TUI
description: Usando la interfaz de usuario del terminal Ottili Coder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Ottili Coder proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Ottili Coder se inicia TUI para el directorio actual.
...
Cuando utilice Ottili Coder TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Ottili Coder. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Ottili Coder. _Alias_: `/quit`, `/q`
...
Esto es independiente de `ottili-coder.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera Ottili Coder después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `ottili-coder.default`.
