...
Créez `.ottili-coder/commands/test.md` :
...
Vous pouvez ajouter des commandes personnalisées via la configuration Ottili Coder ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Ottili Coder [config](/docs/config) :
...
- Par projet : `.ottili-coder/commands/`
...
ottili-coder comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).
