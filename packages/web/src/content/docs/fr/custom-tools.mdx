...
description: Créez des outils que le LLM peut appeler dans ottili-coder.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de ottili-coder comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.ottili-coder/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/ottili-coder/tools/`.
