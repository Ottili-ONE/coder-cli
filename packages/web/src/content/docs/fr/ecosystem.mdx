---
title: Écosystème
description: Projets et intégrations construits avec Ottili Coder.
---

Une collection de projets communautaires construits sur Ottili Coder.

:::note
Vous souhaitez ajouter votre projet lié à Ottili Coder à cette liste ? Soumettez une PR.
:::

Vous pouvez également consulter [awesome-ottili-coder](https://github.com/awesome-ottili-coder/awesome-ottili-coder) et [ottili-coder.cafe](https://ottili.one/coder), une communauté qui regroupe l'écosystème et la communauté.
...
| Nom                                                                                                | Description                                                                                                                            |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Exécute automatiquement des sessions Ottili Coder dans des sandbox Daytona isolées avec synchronisation git et prévisualisations en direct |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Suit l'utilisation d'Ottili Coder avec Wakatime                                                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifications de bureau et alertes sonores pour les sessions Ottili Coder                                                                  |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nommage automatique de session Zellij alimenté par l'IA basé sur le contexte Ottili Coder                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permet aux agents Ottili Coder le chargement différé de prompts à la demande avec découverte et injection de compétences                   |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Étend ottili-coder /commands en un système d'orchestration puissant avec contrôle de flux granulaire                                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifications natives de l'OS pour Ottili Coder – sachez quand les tâches sont terminées                                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sans friction pour Ottili Coder                                                                                              |
...
| Nom                                                                                        | Description                                                                 |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord pour contrôler les sessions Ottili Coder, construit sur le SDK      |
| [ottili-coder.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Plugin Neovim pour des prompts conscients de l'éditeur, construit sur l'API |
| [portal](https://github.com/hosenur/portal)                                                | Interface Web mobile-first pour Ottili Coder via Tailscale/VPN                  |
| [ottili-coder plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Modèle pour créer des plugins Ottili Coder                                      |
| [ottili-coder.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim pour ottili-coder - un agent de codage IA basé sur terminal     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Fournisseur Vercel AI SDK pour utiliser Ottili Coder via @opencode-ai/sdk       |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Application Web / Bureau et extension VS Code pour Ottili Coder                 |
| [Ottili Coder-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian qui intègre Ottili Coder dans l'interface d'Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Une alternative open-source à Claude Cowork, propulsée par Ottili Coder         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestionnaire d'extensions Ottili Coder avec profils portables et isolés.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Application client Bureau, Web, Mobile et Distante pour Ottili Coder            |
