---
title: Zen
description: Liste organisée de modèles fournis par Ottili Coder.
---
...
Ottili Coder est une liste de modèles testés et vérifiés fournie par l'équipe Ottili Coder.

Zen fonctionne comme n'importe quel autre fournisseur dans Ottili Coder. Vous vous connectez à Ottili Coder et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Ottili Coder.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec Ottili Coder.
:::
...
Ottili Coder est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

Ottili Coder fonctionne comme n'importe quel autre fournisseur dans Ottili Coder.

1. Vous vous connectez à **<a href={console}>Ottili Coder</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez Ottili Coder et collez votre clé API.
...
Le [model id](/docs/config/#models) dans votre configuration Ottili Coder utilise le format `ottili-coder/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `ottili-coder/gpt-5.5` dans votre configuration.
...
- DeepSeek V4 Flash Free est disponible sur Ottili Coder pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo-V2.5 Free est disponible sur Ottili Coder pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- North Mini Code Free est disponible sur Ottili Coder pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Ultra Free est disponible sur Ottili Coder pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur Ottili Coder pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé Ottili Coder pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec Ottili Coder également.
