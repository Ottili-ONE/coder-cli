...
Crea `.ottili-coder/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Ottili Coder o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Ottili Coder:
...
- Globale: `~/.config/ottili-coder/commands/`
- Per progetto: `.ottili-coder/commands/`
...
ottili-coder include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
