...
description: Crea strumenti che l'LLM puo chiamare in ottili-coder.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di ottili-coder come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.ottili-coder/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/ottili-coder/tools/`.
