---
title: Ecosistema
description: Progetti e integrazioni costruiti con Ottili Coder.
---

Una raccolta di progetti della comunità costruiti su Ottili Coder.

:::note
Vuoi aggiungere il tuo progetto legato a Ottili Coder a questa lista? Apri una PR.
:::

Puoi anche dare un'occhiata a [awesome-ottili-coder](https://github.com/awesome-ottili-coder/awesome-ottili-coder) e [ottili-coder.cafe](https://ottili.one/coder), una comunità che aggrega ecosistema e community.
...
| Nome                                                                                               | Descrizione                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni Ottili Coder in sandbox Daytona isolate con sync git e anteprime live |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Traccia l'uso di Ottili Coder con Wakatime                                                            |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifiche desktop e avvisi sonori per le sessioni Ottili Coder                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Naming automatico delle sessioni Zellij basato sul contesto Ottili Coder                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permette agli agenti Ottili Coder di caricare prompt al bisogno con discovery e injection di skill    |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estende ottili-coder /commands in un sistema di orchestrazione con controllo di flusso granulare      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifiche native del sistema per Ottili Coder: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git worktree senza attriti per Ottili Coder                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni Ottili Coder, costruito sull'SDK    |
| [ottili-coder.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Plugin Neovim per prompt consapevoli dell'editor, costruito sull'API |
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per Ottili Coder su Tailscale/VPN                    |
| [ottili-coder plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin Ottili Coder                               |
| [ottili-coder.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim per ottili-coder: un agente di coding AI per terminale   |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare Ottili Coder tramite @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per Ottili Coder                   |
| [Ottili Coder-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra Ottili Coder nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da Ottili Coder      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni Ottili Coder con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per Ottili Coder                |
