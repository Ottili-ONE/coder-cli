...
`.ottili-coder/commands/test.md` を作成します。
...
カスタムコマンドは、Ottili Coder 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

Ottili Coder [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/ottili-coder/commands/`
- プロジェクトごと: `.ottili-coder/commands/`
...
Ottili Coder には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
