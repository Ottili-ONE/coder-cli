...
전체 ID는 `provider_id/model_id`입니다. 예를 들어, [Ottili Coder](/docs/zen)을 사용한다면, GPT 5.1 Codex에 `ottili-coder/gpt-5.1-codex`를 사용할 수 있습니다.
