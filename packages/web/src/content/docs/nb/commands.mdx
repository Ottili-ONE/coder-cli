...
Opprett `.ottili-coder/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Ottili Coder-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Ottili Coder [config](/docs/config):
...
- Per prosjekt: `.ottili-coder/commands/`
...
Ottili Coder inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
