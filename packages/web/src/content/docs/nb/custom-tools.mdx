...
description: Lag verktøy som LLM kan kalle inn Ottili Coder.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Ottili Coder sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.ottili-coder/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/ottili-coder/tools/`.
