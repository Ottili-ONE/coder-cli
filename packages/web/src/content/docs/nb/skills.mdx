...
Agentferdigheter lar Ottili Coder oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
ottili-coder søker etter disse stedene:

- Prosjektkonfigurasjon: `.ottili-coder/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/ottili-coder/skills/<name>/SKILL.md`
...
For prosjektlokale stier går ottili-coder opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.ottili-coder/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/ottili-coder/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.ottili-coder/skills/git-release/SKILL.md` slik:
...
ottili-coder viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `ottili-coder.json`:
...
**For innebygde agenter** (i `ottili-coder.json`):
