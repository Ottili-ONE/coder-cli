...
Utwórz `.ottili-coder/commands/test.md`:
...
Możesz zdefiniować polecenia w `ottili-coder.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji ottili-coder:
...
- Globalnie: `~/.config/ottili-coder/commands/`
- Na projekt: `.ottili-coder/commands/`
...
ottili-coder zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
