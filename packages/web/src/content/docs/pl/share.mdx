---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące ottili-coder.
---

Funkcja udostępniania ottili-coder umożliwia tworzenie publicznych linków do konwersacji ottili-coder, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, ottili-coder:
...
ottili-coder obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie ottili-coder korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `ottili-coder.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu ottili-coder w Twojej organizacji.
