---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala ottili-coder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ottili-coder zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie ottili-coder uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI ottili-coder, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do ottili-coder. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij ottili-coder. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `ottili-coder.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Ottili Coder czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `ottili-coder.default`.
