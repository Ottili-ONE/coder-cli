...
description: Crie ferramentas que o LLM pode chamar no ottili-coder.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do ottili-coder, como `read`, `write` e `bash`.
...
- Localmente, colocando-as no diretório `.ottili-coder/tools/` do seu projeto.
- Ou globalmente, colocando-as em `~/.config/ottili-coder/tools/`.
