---
title: Ecossistema
description: Projetos e integrações construídos com o Ottili Coder.
---

Uma coleção de projetos da comunidade construídos sobre o Ottili Coder.

:::note
Quer adicionar seu projeto relacionado ao Ottili Coder a esta lista? Envie um PR.
:::

Você também pode conferir [awesome-ottili-coder](https://github.com/awesome-ottili-coder/awesome-ottili-coder) e [ottili-coder.cafe](https://ottili.one/coder), uma comunidade que agrega o ecossistema e a comunidade.
...
| Nome                                                                                               | Descrição                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Execute automaticamente sessões do Ottili Coder em sandboxes isoladas do Daytona com sincronização git e pré-visualizações ao vivo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Acompanhe o uso do Ottili Coder com Wakatime                                                                                       |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificações de desktop e alertas sonoros para sessões do Ottili Coder                                                             |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomeação automática de sessões Zellij com suporte de IA com base no contexto do Ottili Coder                                       |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permite que agentes do Ottili Coder carreguem prompts sob demanda com descoberta e injeção de habilidades                          |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estenda ottili-coder /commands em um poderoso sistema de orquestração com controle de fluxo granular                               |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificações nativas do OS para Ottili Coder – saiba quando as tarefas são concluídas                                              |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sem atrito para Ottili Coder                                                                                         |
...
| Nome                                                                                       | Descrição                                                                       |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot do Discord para controlar sessões do Ottili Coder, construído sobre o SDK       |
| [ottili-coder.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Plugin Neovim para prompts cientes do editor, construído sobre a API            |
| [portal](https://github.com/hosenur/portal)                                                | UI web mobile-first para Ottili Coder sobre Tailscale/VPN                           |
| [ottili-coder plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template para construir plugins do Ottili Coder                                     |
| [ottili-coder.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim para Ottili Coder - um agente de codificação IA baseado em terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provedor Vercel AI SDK para usar Ottili Coder via @opencode-ai/sdk                  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicativo Web / Desktop e Extensão do VS Code para Ottili Coder                    |
| [Ottili Coder-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian que incorpora Ottili Coder na UI do Obsidian                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Uma alternativa de código aberto ao Claude Cowork, alimentada pelo Ottili Coder     |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gerenciador de extensões Ottili Coder com perfis portáteis e isolados.              |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicativo Desktop, Web, Mobile e Cliente Remoto para Ottili Coder                  |
