---
title: Share
description: Share your Ottili Coder conversations.
---

Ottili Coder's share feature allows you to create public links to your Ottili Coder conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Ottili Coder:
...
Ottili Coder supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Ottili Coder uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `ottili-coder.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using ottili-coder in your organization.
