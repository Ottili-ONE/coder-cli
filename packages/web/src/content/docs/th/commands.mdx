...
สร้าง `.ottili-coder/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Ottili Coder:
...
- ระดับผู้ใช้ (Global): `~/.config/ottili-coder/commands/`
- ระดับโปรเจ็กต์: `.ottili-coder/commands/`
...
Ottili Coder มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
