...
`.ottili-coder/commands/test.md` oluştur:
...
ottili-coder işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

ottili-coder [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/ottili-coder/commands/`
- Proje başına: `.ottili-coder/commands/`
...
ottili-coder, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
