---
title: Özel Araçlar
description: LLM'un ottili-coder'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. ottili-coder'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.ottili-coder/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/ottili-coder/tools/` içine yerleştirerek.
