---
title: Ekosistem
description: Ottili Coder ile geliştirilen projeler ve entegrasyonlar.
---

Ottili Coder üzerine inşa edilmiş topluluk projeleri koleksiyonu.

:::note
Ottili Coder ile ilgili projenizi bu listeye eklemek ister misiniz? Bir PR gönderin.
:::

Ayrıca ekosistemi ve topluluğu bir araya getiren [awesome-ottili-coder](https://github.com/awesome-ottili-coder/awesome-ottili-coder) ve [ottili-coder.cafe](https://ottili.one/coder) adreslerine de göz atabilirsiniz.
...
| İsim                                                                                               | Açıklama                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Ottili Coder oturumlarını, git senkronizasyonu ve canlı önizlemelerle izole Daytona sanal alanlarında otomatik olarak çalıştırın  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime ile Ottili Coder kullanımını takip edin                                                                                  |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Ottili Coder oturumları için masaüstü bildirimleri ve sesli uyarılar                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Ottili Coder bağlamına dayalı yapay zeka destekli otomatik Zellij oturum isimlendirmesi                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Ottili Coder aracılarının, beceri keşfi ve enjeksiyonu ile istemleri talep üzerine tembel yüklemesine (lazy load) izin verin      |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | ottili-coder /commands komutlarını, ayrıntılı akış kontrolü ile güçlü bir orkestrasyon sistemine genişletin                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Ottili Coder için yerel işletim sistemi bildirimleri – görevlerin ne zaman tamamlandığını bilin                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Ottili Coder için sıfır sürtünmeli git çalışma ağaçları (worktrees)                                                               |
...
| İsim                                                                                       | Açıklama                                                                        |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK üzerine inşa edilmiş, Ottili Coder oturumlarını kontrol eden Discord botu       |
| [ottili-coder.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | API üzerine inşa edilmiş, editör farkındalıklı istemler için Neovim eklentisi   |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN üzerinden Ottili Coder için mobil öncelikli web arayüzü               |
| [ottili-coder plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Ottili Coder eklentileri oluşturmak için şablon                                     |
| [ottili-coder.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | ottili-coder için Neovim ön yüzü - terminal tabanlı bir yapay zeka kodlama aracısı  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk aracılığıyla Ottili Coder kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Ottili Coder için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [Ottili Coder-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Ottili Coder'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Ottili Coder tarafından desteklenen, Claude Cowork'e açık kaynaklı bir alternatif   |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Taşınabilir, izole profillere sahip Ottili Coder eklenti yöneticisi                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Ottili Coder için Masaüstü, Web, Mobil ve Uzak İstemci Uygulaması                   |
