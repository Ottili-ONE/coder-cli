...
description: ottili-coder dile özgü biçimlendiriciler kullanır.
---

ottili-coder, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

ottili-coder, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, ottili-coder bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

ottili-coder bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri ottili-coder yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
