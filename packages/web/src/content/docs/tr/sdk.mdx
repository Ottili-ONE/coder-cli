---
title: SDK
description: ottili-coder sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

ottili-coder JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
ottili-coder'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir ottili-coder örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `ottili-coder.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir ottili-coder örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
