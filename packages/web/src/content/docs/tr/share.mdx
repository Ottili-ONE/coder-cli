---
title: Paylasim
description: ottili-coder konusmalarini genel baglantilarla paylasin.
---

ottili-coder'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda ottili-coder:
...
ottili-coder, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak ottili-coder manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `ottili-coder.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda ottili-coder kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
