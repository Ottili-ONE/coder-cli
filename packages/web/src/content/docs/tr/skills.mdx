...
Ajan becerileri, ottili-coder'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
ottili-coder su konumlari tarar:

- Proje konfigurasyonu: `.ottili-coder/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/ottili-coder/skills/<name>/SKILL.md`
...
Proje yerel yollarinda ottili-coder, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.ottili-coder/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/ottili-coder/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.ottili-coder/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
ottili-coder, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`ottili-coder.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`ottili-coder.json` icinde):
