...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Ottili-ONE/coder-cli/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/ottiliCoder...\n")
...
console.log("Fetching npm all-time downloads for ottili-coder-ai...\n")
const npmDownloads = await fetchNpmDownloads("ottili-coder-ai")
